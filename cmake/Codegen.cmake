...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_RVV_FOUND)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DHAVE_RVV_CPU_DEFINITION")
    LIST(APPEND CPU_CAPABILITY_NAMES "RVV")
    LIST(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG}  ${CXX_RVV_FLAGS}")
  endif(CXX_RVV_FOUND)
